...
export const KlettaLogo = ({ className, color = 'black' }: { className?: string; color?: 'black' | 'white' }) => {
  ...
  return (
   <svg width="100" height="28" viewBox="0 0 196 55" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M149.617 24.5631V39.8531C149.617 41.9531 150.002 43.4349 150.771 44.2961C151.54 45.1597 153.022 45.5915 155.214 45.5915C155.424 45.5915 155.67 45.5797 155.948 45.5561C156.229 45.5325 156.566 45.5089 156.963 45.4853C157.359 45.4617 157.696 45.4381 157.977 45.4145V53.673C155.434 54.1402 153.102 54.3738 150.979 54.3738C147.34 54.3738 144.634 53.6636 142.862 52.2407C141.135 50.7943 140.064 49.2205 139.644 47.5169C139.271 45.6033 139.084 41.7077V24.5631H124.67V39.8531C124.67 41.9295 125.059 43.4042 125.842 44.2796C126.623 45.155 128.075 45.5915 130.198 45.5915C130.385 45.5915 130.618 45.5797 130.899 45.5561C131.18 45.5325 131.534 45.5089 131.966 45.4853C132.397 45.4617 132.765 45.4381 133.067 45.4145V53.673C130.524 54.1402 128.181 54.3738 126.034 54.3738C122.674 54.3738 120.057 53.7155 118.179 52.3965C116.3 51.0798 115.116 49.4517 114.627 47.5145C114.255 45.6009 114.068 43.6661 114.068 41.7073V24.5608H106.126V15.9885H114.068V4.30396H124.67V15.9908H139.084V4.30396H149.615V15.9908H158.572V24.5631H149.615H149.617Z" fill={fill}/>
