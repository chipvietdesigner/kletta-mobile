    ...
    return (
        <div className="h-full w-full bg-white flex flex-col font-aktifo animate-fade-in relative overflow-hidden">
            ...
            <div className="bg-kletta-teal w-full z-20 shadow-sm shrink-0">
                {/* Status Bar */}
                <div className="w-full h-[30px] flex justify-between items-end px-6 pb-2 text-white pointer-events-none">
                </div>
                ...
                <div className="pt-2 pb-6 px-6 flex flex-col items-center relative">
                   ...
                   <p className="text-[14px] text-white/70 font-normal">01.04.2025</p>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pt-0 pb-32">
                ...
                <div className="px-6 space-y-3 mb-8">
                    <div className="flex justify-between items-center py-2 border-b border-gray-100/50">
                        <span className="text-[15px] text-gray-500 font-normal">Accounting period</span>
                        <span className="text-[15px] font-medium text-kletta-dark">1.1–31.12.2024</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-100/50">
                        <span className="text-[15px] text-gray-500 font-normal">Status</span>
                        <div className="flex items-center gap-1.5">
                             <IconCheckCircle size={18} weight="fill" className="text-green-600" />
                             <span className="text-[15px] font-medium text-kletta-dark">Completed</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-6 mb-10">
                    <h3 className="text-[16px] font-semibold text-kletta-dark mb-5">Business Income</h3>
                    <div className="space-y-4">
                        <ReportRow label="Revenue" value="€209,224.86" medium/>
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <ReportRow label="External services" value="€15,224.80" medium />
                        <ReportRow label="Staff expenses (e.g. YEL)" value="€13,556.05" />
                        <ReportRow label="Depreciation" value="€15,000.00" />
                        <ReportRow label="Entertainment expenses (50%)" value="€5,158.39" />
                        <ReportRow label="Rental expenses" value="€190.91" />
                        <ReportRow label="Other deductible expenses" value="€5,108.81" />
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <ReportRow label="Additions during the tax year" value="€60,000.00"/>
                        <ReportRow label="Sales prices and insurance compensations" value="€0.00" />
                        <ReportRow label="Depreciation for the tax year" value="€15,000.00" />
                        <ReportRow label="Remaining taxable balance at the end of the tax year" value="€45,000.00" highlight />
                    </div>
                </div>
                ...
                <div className="px-6 mb-10">
                    ...
                    <p className="text-[13px] text-gray-500 mb-5">(Over 50% of business use)</p>
                    <div className="space-y-4">
                        <ReportRow label="Total kilometers" value="161,213 km" />
                        <ReportRow label="Total costs" value="€19,128.00" />
                        <ReportRow label="Vehicle depreciation" value="€15,000.00" indent />
                        <ReportRow label="Vehicle costs" value="€4,128.00" indent />
                        <ReportRow label="Costs / km" value="€0.12 / km" />
                        <ReportRow label="Depreciation for the tax year" value="€15,000.00" bold />
                        <ReportRow label="Private use" value={<div><p className="text-right">€18,125.17</p><p className="text-[12px] text-gray-500">(152,761 km)</p></div>} />
                    </div>
                </div>
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <ReportRow label="Business use share of the costs" value="€2,000.00" highlight />
                    </div>
                </div>
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="space-y-4">
                        <ReportRow label="Travel in Finland over 10h" value={<div><p className="text-right">€1,173.00</p><p className="text-[12px] text-gray-500">(23 days)</p></div>} />
                        <ReportRow label="Travel in Finland over 6h" value={<div><p className="text-right">€24.00</p><p className="text-[12px] text-gray-500">(1 day)</p></div>} />
                        <ReportRow label="Travel abroad" value="€0.00" />
                ...
                <div className="px-6 mb-10">
                    ...
                    <p className="text-[13px] text-gray-500 mb-5">(Over 50% of private use)</p>
                    <div className="space-y-4">
                        <ReportRow label="Total kilometers" value="109,831 km" />
                        <ReportRow label="Business use" value={<div><p className="text-right">€328.89</p><p className="text-[12px] text-gray-500">(577 km)</p></div>}  />
                    </div>
                </div>
                ...
                <div className="px-6 mb-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <ReportRow label="Machinery and equipment" value="€45,000.00" />
                        ...
                        <ReportRow label="Accounts receivable" value="€8,703.94" />
...
const ReportRow = ({ label, value, bold, indent, highlight, large }: any) => (
    <div className={`flex items-center justify-between gap-4 py-1.5 ${indent ? 'pl-5' : ''}`}>
        <span className={`text-[15px] flex-1 min-w-0 ${bold ? 'font-bold' : 'font-normal'} ${highlight ? 'text-kletta-dark font-bold' : 'text-gray-500'} leading-tight`}>
            {label}
        </span>
        <div className={`shrink-0 ${highlight ? 'text-kletta-dark font-bold' : 'text-kletta-dark font-normal'} ${large ? 'text-[18px]' : 'text-[15px]'}`}>
            {value}
        </div>
    </div>
);
...
const ContactBtn = () => (
    <button className="px-4 py-1.5 border border-gray-200 rounded-full text-[13px] font-normal text-kletta-dark hover:bg-gray-50 active:bg-gray-100 transition-colors">
        Contact us
    </button>
);
...
const InputBox = ({ value, placeholder, suffix }: any) => (
    <div className="relative flex items-center">
        ...
        />
        {suffix && <span className="absolute -right-6 text-[12px] text-gray-500 font-normal">{suffix}</span>}
    </div>
);
...
const RadioItem = ({ selected, label }: any) => (
    <div className="flex items-start gap-4 group cursor-pointer">
        ...
        <span className={`text-[15px] font-normal leading-tight ${selected ? 'text-kletta-dark font-bold' : 'text-kletta-dark opacity-80'}`}>
            {label}
        </span>
    </div>
);
